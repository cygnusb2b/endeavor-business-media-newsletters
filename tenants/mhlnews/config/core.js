module.exports = {
  optOut: {
    address: 'Material Handling & Logistics<br />Endeavor Business Media<br />331 54th Avenue N.<br />Nashville, TN 37209',
    ...
    manageSubscriptions: 'https://endeavor.dragonforms.com/loading.do?omedasite=IDWPrefPage',
    signUp: 'https://endeavor.dragonforms.com/loading.do?omedasite=MHLPrefPage',
  },
  socialMediaLinks: [
    {
      provider: 'twitter',
